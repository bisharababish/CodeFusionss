...
const TeamsText = styled(motion.div)`
  text-align: center;
  margin-bottom: 4rem;
        ...
        <TeamsSection id="teams">
            ...
            <TeamsContent>
                ...
                >
                    ...
                    >
                        Meet the talented individuals behind CodeFusion. Our diverse team of experts
                        brings together years of experience in development, design, and innovation
                    ...
                    >
                        Each team member brings unique skills and perspectives, working collaboratively
                        to solve complex challenges and create innovative solutions that drive business growth.
                    </Subtitle>
                    <TeamGrid
                        ref={ref}
                                ...
                                <CardInner isFlipped={flippedCards[member.id] || false}>
                                    <CardFront>
                                        ...
                                        <MemberInfo>
                                            ...
                                            <MemberRole dangerouslySetInnerHTML={{ __html: member.role }}></MemberRole>
                                        </MemberInfo>
                                    </CardFront>
                                    <CardBack>
                                        <MemberName>{member.name}</MemberName>
                                        <MemberRole>{member.bio}</MemberRole>
                                        <SocialLinks>
                                            <SocialLink
